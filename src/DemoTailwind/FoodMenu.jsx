...
export default function FoodMenu() {
    ...
    const renderFoodCategory =()=>{
        ...
        <li className='transition hover:bg-orange-500 duration-500' key={index} onClick={()=> handleClick(item.categoryId)}>
            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-20 mb-20 mx-auto">
                    <div className="flex flex-wrap -m-4 px-6">
                        {_.filter(data, item=> item.categoryId === categoryID).map((item, index)=> (
                            <div className="p-4 lg:w-1/2" key={index}>
                                ...
                                <a onClick={() => {
                                    ...
                                    className="text-yellow-500 inline-flex items-center cursor-pointer">Learn More
